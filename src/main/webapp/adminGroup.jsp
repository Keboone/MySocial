...
<html>
	...
	<body>
		...
		<div class="main-box clearfix" id="content">
			...
			<h2 align="center">Members of the Admin group:</h2>
			
			<sql:query dataSource="${mysocial}" var="result">
			
				SELECT id, name, surname, role
				FROM user
				WHERE biggroup_bigGroupId = 3;	
			...
			<h2 align="center">Admin group wall</h2>
			...
			<sql:query dataSource="${mysocial}" var="result">
				...
				join user u
				on u.id = gp.user_id
				where gp.biggroup_bigGroupId = 3;
			...
			<table border="1" width="100%">
				...
				<c:forEach var="row" items="${result.rows}">
					...
					<tr>
						...
						<td align="center"><a href="groupPostComments3.jsp">@</a></td>
			...
			<div align="center">
				...
				<form action="sharePostToGroup" method="post">
					...
					<textarea name="writtenText" cols="29" rows="5" ></textarea><br>
