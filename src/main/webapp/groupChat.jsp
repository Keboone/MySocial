	...
	<body>
		...
		<div class="main-box clearfix" id="content">
			...
			<sql:query dataSource="${mysocial}" var="result">
				SELECT * FROM conversation WHERE conversationId = 3;
			</sql:query>
			...
			<sql:query dataSource="${mysocial}" var="result">
				SELECT * FROM message m JOIN conversation c ON m.conversation_id = c.conversationId AND conversationId = 3;
			</sql:query>
			...
			<form action="sendGroupMessageServlet" method="post">
