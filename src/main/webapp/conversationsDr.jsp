...
<html>
	...
	<body>
		...
		<div class="main-dark clearfix" id="content">
			...
			<div align="center">
				<a href="../MySocial/firstConversationDr.jsp"><button class="button">Conversation with Harry</button></a>
				
				<a href="../MySocial/secondConversationDr.jsp"><button class="button">Conversation with Richard</button></a>
			</div>
