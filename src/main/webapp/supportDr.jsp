...
<html>
	...
	<body>
		...
		<div class="main-dark clearfix">
			<div class="wrong-login" id="content">
			
	            <h1>Welcome in Support</h1>
                If you have any problem</br></br>
            	<a href="mailto:MySocial@gmail.com"><button class="button">Write Us An Email</button></a>
