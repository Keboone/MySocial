...
CREATE TABLE `groupmember` (
  ...
  PRIMARY KEY (`groupMemberId`,`user_id`,`conversation_id`),
  KEY `fk_groupmember_user_idx` (`user_id`),
  KEY `fk_groupmember_conversation1_idx` (`conversation_id`),
  CONSTRAINT `fk_groupmember_conversation1` FOREIGN KEY (`conversation_id`) REFERENCES `conversation` (`conversationId`),
...
INSERT INTO `groupmember` VALUES (1,1,1),(1,1,2),(2,2,1),(2,2,2),(3,3,2);
